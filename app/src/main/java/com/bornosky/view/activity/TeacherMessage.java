...
public class TeacherMessage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> branchAdapter = new ArrayAdapter<>(TeacherMessage.this, R.layout.spinner_item, branchArray);
        ...
        spinnerBranch.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!s1.contentEquals("Select Branch")) {
                    ...
                    ArrayAdapter<String> shiftAdapter = new ArrayAdapter<>(TeacherMessage.this, R.layout.spinner_item, shiftArray);
                    ...
                    spinnerShift.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        ...
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            if (!s1.contentEquals("Select shift")) {
                                ArrayAdapter<String> messageTypeAdapter = new ArrayAdapter<>(TeacherMessage.this, R.layout.spinner_item, messageTypeArray);
        ...
        checkAll.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    DataItemAdapter adapter = new DataItemAdapter(TeacherMessage.this, dataItemList);
                    RecyclerView recyclerView = (RecyclerView) findViewById(R.id.rvItems);
                    recyclerView.setAdapter(adapter);
                } else {
            ...
            public void onClick(View v) {
                ...
                if (checkedPhoneList.size() > 0) {
                    for (int i = 0; i < checkedPhoneList.size(); i++) {
                        Toast.makeText(TeacherMessage.this, "your number " + checkedPhoneList.get(i), Toast.LENGTH_SHORT).show();
...
/*
                ...
                if (checkedAllPhoneList.size() > 0) {
                    for (int i = 0; i < checkedAllPhoneList.size(); i++) {
                        Toast.makeText(TeacherMessage.this, "your number " + checkedAllPhoneList.get(i), Toast.LENGTH_SHORT).show();
                        SmsManager sms = SmsManager.getDefault();
                        message = etmessage.getText().toString();
