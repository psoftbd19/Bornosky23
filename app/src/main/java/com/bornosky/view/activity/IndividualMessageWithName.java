...
public class IndividualMessageWithName extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.smswith_name);
        setTitle("MessageWithName");
        ...
        spinnerSession.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!s1.contentEquals("Select session")) {
                    ArrayAdapter<String> branchAdapter = new ArrayAdapter<>(IndividualMessageWithName.this, R.layout.spinner_item, branchArray);
                    ...
                    spinnerBranch.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        ...
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            if (!s1.contentEquals("Select Branch")) {
                                ArrayAdapter<String> classAdapter = new ArrayAdapter<>(IndividualMessageWithName.this, R.layout.spinner_item, classArray);
                                ...
                                spinnerClass.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                    ...
                                    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                                        ...
                                        if (!s1.contentEquals("Select class")) {
                                            ArrayAdapter<String> shiftAdapter = new ArrayAdapter<>(IndividualMessageWithName.this, R.layout.spinner_item, shiftArray);
                                            ...
                                            spinnerShift.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                                ...
                                                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                                                    ...
                                                    if (!s1.contentEquals("Select shift")) {
                                                        ArrayAdapter<String> sectionAdapter = new ArrayAdapter<>(IndividualMessageWithName.this, R.layout.spinner_item, sectionArray);
                                                        ...
                                                        spinnerSection.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                                            ...
                                                            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                                                              ...
                                                              /*      ArrayAdapter<String> messageTypeAdapter = new ArrayAdapter<>(IndividualMessageWithName.this, R.layout.spinner_item, messageTypeArray);
        ...
        checkAll.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    DataItemAdapter adapter = new DataItemAdapter(IndividualMessageWithName.this, dataItemList);
                    RecyclerView recyclerView = (RecyclerView) findViewById(R.id.rvItems);
                    recyclerView.setAdapter(adapter);
                } else {
            ...
            public void onClick(View v) {
                ...
                if (checkedPhoneList.size() > 0) {
                    for (int i = 0; i < checkedPhoneList.size(); i++) {
                        Toast.makeText(IndividualMessageWithName.this, "your number " + checkedPhoneList.get(i), Toast.LENGTH_SHORT).show();
                        SmsManager sms = SmsManager.getDefault();
                        String header = etHeader.getText().toString();
                        message = etmessage.getText().toString();

                        String smsForm = header + "\n" + message;

                        sms.sendTextMessage(checkedPhoneList.get(i), null, smsForm, null, null);
...
/*
                ...
                if (checkedAllPhoneList.size() > 0) {
                    for (int i = 0; i < checkedAllPhoneList.size(); i++) {
                        Toast.makeText(IndividualMessageWithName.this, "your number " + checkedAllPhoneList.get(i), Toast.LENGTH_SHORT).show();
                        SmsManager sms = SmsManager.getDefault();
                        message = etmessage.getText().toString();
